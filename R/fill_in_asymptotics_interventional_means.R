...
## Documentation
#' @title Function to fill in asymptotic quantities of the interventional means
...
#' interventional means into the internal list.
#' @param internal_list A list with various information extracted from the model.
#' @return \code{fill_in_asymptotics_interventional_means} returns the inputted
...
fill_in_asymptotics_interventional_means <- function(internal_list){
  ...
  internal_list$interventional_distribution$jacobian$means <- jacobian
  internal_list$interventional_distribution$acov$means <- ase$acov_gamma_1
  internal_list$interventional_distribution$ase$means <- ase$ase_gamma_1
  internal_list$interventional_distribution$z_values$means <- ase$z_gamma_1
