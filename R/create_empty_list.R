...
#' @return \code{create_empty_list} returns an empty internal list with the 
...
#'      .. ..$ labels: chr[0, 0]   \tab \tab parameter names of matrix of 
#'      structural coefficients\cr
...
#'      .. ..$ labels: chr[0, 0]   \tab \tab parameter names of model implied 
#'      covariance matrix\cr
#'      .. ..$ derivative: chr[0, 0]  \tab \tab partial derivative of the 
...
#'      ..$ intervention_names: chr(0)  \tab \tab names of interventional variables\cr
#'      ..$ n_outcome: int 0            \tab \tab number of outcome variables\cr
#'      ..$ outcome_names: chr(0)       \tab \tab names of outcome variables\cr
#'      ..$ intervention_levels: num(0) \tab \tab interventional level\cr
...
#'      .. .. $ values: num(0)      \tab \tab mean vector of the interventional distribution  \cr
#'      .. .. $ jacobian: num[0, 0] \tab \tab jacobian of interventinoal mean vector \cr
#'      .. .. $ ase: num(0)         \tab \tab asymptotic standard errors of the interventional means  \cr
#'      .. .. $ z_values: num[0, 0] \tab \tab z-values of the interventional means \cr
#'      ..$ covariance_matrix: List of 4    \tab \tab \cr
#'      .. .. $ values: num(0)      \tab \tab covariance matrix of the interventional distribution  \cr
#'      .. .. $ jacobian: num[0, 0] \tab \tab jacobian of the VECTORIZED interventional covariance matrix \cr
#'      .. .. $ ase: num(0)         \tab \tab asymptotic standard errors of the interventional (co)variances  \cr
#'      .. .. $ z_values: num[0, 0] \tab \tab z-values of the interventional interventional (co)variances \cr
#'      ..$ density_function: List of 4    \tab \tab \cr
#'      .. .. $ values: num(0)      \tab \tab probability density function (pdf) of the interventional distribution  \cr
#'      .. .. $ jacobian: num[0, 0] \tab \tab jacobian of the pdf of the interventional distribution\cr
#'      .. .. $ ase: num(0)         \tab \tab asymptotic standard errors of the interventional pdf   \cr
#'      .. .. $ z_values: num[0, 0] \tab \tab z-values of the interventional pdf \cr
#'      ..$ probabilities: List of 4  \tab \tab \cr
#'      .. .. $ values: num(0)      \tab \tab probabilities of interventional events \cr
#'      .. .. $ jacobian: num[0, 0] \tab \tab jacobian of interventinoal probabilities \cr
#'      .. .. $ ase: num(0)         \tab \tab asymptotic standard error of interventional probabilities  \cr
