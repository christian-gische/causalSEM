###################################################
### Tests for function build_C 0.0.6 2021-09-21 ###
###################################################
...
# source build_C and necessary functions (only when running this file manually)
...
file.expected <- file.path( shell( "echo %USERPROFILE%", intern=TRUE ), "Dropbox/causalSEM_R_Package/expected_test_results/build_C-0.0.6-2021-09-21_expected.Rdata" )
load( file.expected )
